...
have made a more clear way of demonstrating the outliers so I marked the code as comments and generated markdown cells. I also used the code from the class in order to write the line regression section. 